...
public class TransactionTest {
    ...
    public void testCreate() {
        ...
        Transaction transaction = new Transaction(expected_id, expected_user, expected_products,
                expected_dateTime, expected_paymentMethod);
    ...
    public void testToString() {
        ...
        Transaction transaction = new Transaction(id, user, products, dateTime, paymentMethod);
        String productList = "";
        ...
        String expected_string = String.format(Transaction.STRING_FORMAT, id, user, dateTime, paymentMethod, productList);;
