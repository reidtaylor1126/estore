...
public interface CartDAO {
    ...
    /**
     * Attempts to find a user matching the provided token and replaces their {@link Cart} with the
     * provided one
     * 
     * @param token The user's authentication token
    ...
    /**
     * Attempts to find a user matching the provided token and unregisters and deletes their
     * {@link Cart}<br>
